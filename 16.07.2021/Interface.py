...
class AutomatUI (Tk):      ## основной класс интерфейса  
    def __init__(self):    ## конструктор
        super().__init__()
        self.geometry('550x600')
        self.numbers_buttons = [Button(self, text=str(i)) for i in range (10)]    ## генератор листа
        ...
        self.goods_list_text = Text(self)                ## создаем поле для перечня товаров
    ...
    def set_command(self, obj, command, **kwargs):    ## обьеденяет обьект интерфейса и команду
